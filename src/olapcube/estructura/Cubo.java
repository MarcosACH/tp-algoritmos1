...
public class Cubo {
     ...
     * @throws IllegalArgumentException Si la dimensión pasada no se encuentra en el
     *                                  cubo
     */
    ...
    /**
     * Método que genera un nuevo cubo que unicamente tengo los hechos que cumplan
     * que en la dimensión pasada tengan ese valor
     * 
    ...
    /**
     * Método que genera un nuevo cubo que unicamente tengo los hechos que cumplan
     * que en la dimensión pasada tengan alguno de esos valores
     * 
     * @param nombreDim Dimensión en la que se aplica
     * @param valor     Valor que deben tener los hechos del nuevo cubo
    ...
    /**
     * Método que genera un nuevo cubo que unicamente tengo los hechos que cumplan
     * que en la dimensiones pasadas tengan alguno de esos valores
     * 
     * @param nombreDim Dimensión 1
     * @param valores1  Valores que deben tener los hechos del nuevo cubo en la
     *                  dimension 1
     * @param nombreDim Dimensión 2
     * @param valores2  Valores que deben tener los hechos del nuevo cubo en la
     *                  dimension 2
     * @return Cubo que en esas dimensiones solo tiene hechos con esos valores
     * @throws IllegalArgumentException Si algun nombreDim no es una dimensión del
     *                                  cubo
     */
     ...
     * @param valores3  Valores que deben tener los hechos del nuevo cubo en la
     *                  dimension 3
     * @return Cubo que en esas dimensiones solo tiene hechos con esos valores
     * @throws IllegalArgumentException Si algun nombreDim no es una dimensión del
     *                                  cubo
     */
    public Cubo dice(String nombreDim1, String[] valores1, String nombreDim2, String[] valores2, String nombreDim3,
            String[] valores3) {
        Cubo cubo = this.copiar();
        cubo.dimensiones.get(nombreDim1).filtrar(valores1);
        cubo.dimensiones.get(nombreDim2).filtrar(valores2);
