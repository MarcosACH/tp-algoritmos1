...
public class ConfigHechos {
     ...
     * @param columnas      Columnas de los hechos (columnas con valores del dataset
     *                      de hechos)
    ...
    /**
     * Método constructor que permite crear una configuración de hechos a partir de
     * un archivo CSV
     * 
     * @param filePath Ruta del archivo CSV
     * @param nombres  Nombres de los hechos
     * @param columnas Columnas de los hechos (columnas con valores del dataset de
     *                 hechos)
     * @return Configuración de los hechos
     */
