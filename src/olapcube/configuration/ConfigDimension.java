...
public class ConfigDimension {
    ...
    private int[] columnasJerarquias; // primer numero = jerarquia mas abstracta, ultimo numero = jerarquia menos
                                      // abstracta, columnas en las que están las jerarquias en el dataset de la
                                      // dimensión
     ...
     * @param columnaKey         Columna que contiene la clave primaria en el
     *                           dataset de la dimensión
     * @param columnaValor       Columna que contiene el valor en el dataset de la
     *                           dimensión
     * @param columnaFkHechos    Columna que contiene la clave foránea en el dataset
     *                           de los hechos
     * @param columnasJerarquias Columnas que contienen cada nivel de jerarquia en
     *                           la tabla de la dimensión
     */
    private ConfigDimension(String nombre, DatasetReader datasetReader, int columnaKey, int columnaValor,
            int columnaFkHechos, int[] columnasJerarquias) {
        this.nombre = nombre;
     ...
     * @param columnaKey         Columna que contiene la clave primaria en la tabla
     *                           de la dimensión
     * @param columnaValor       Columna que contiene el valor en la tabla de la
     *                           dimensión
     * @param columnaFkHechos    Columna que contiene la clave foránea en la tabla
     *                           de los hechos
     * @param columnasJerarquias Columnas que contienen cada nivel de jerarquia en
     *                           la tabla de la dimensión
     * @return
     */
    public static ConfigDimension configCSV(String nombre, String filePath, int columnaKey, int columnaValor,
            int columnaFkHechos, int[] columnasJerarquias) {
